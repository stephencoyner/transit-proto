...
const MOCK_INSIGHTS: InsightsResponse = {
  ...
  dateRange: { start: '2025-06-22', end: '2025-09-30' },
  toolCallCount: 11,
  summary: 'Good morning! Route 44 is the headline \u2014 PM peak boardings jumped 74% the first week of UW fall quarter and every 5 PM trunk trip is hitting crush capacity. I\u2019ve drafted an operational response below. Route 62 is also running hot, and Route 13 weekend ridership keeps slipping. Overall system ridership up 4% since July.',
  insights: [
    {
      id: 'mock-r44-v6',
      category: 'crowding',
      severity: 'critical',
      title: 'Route 44: UW\u2019s Return Causes Crowding',
      narrative: 'UW is back and Route 44 is maxed out. Every PM trip has hit crush capacity since fall quarter started \u2014 passengers standing from UW through Wallingford.',
      hypothesis: 'UW fall quarter (Sep 24 start) has shifted Route 44 into a new operating baseline. Outbound PM peak demand from UW now exceeds articulated-bus capacity on every trunk trip between 5:00 and 5:55 PM, and relief doesn\u2019t arrive until Wallingford/Ballard.',
      analysisSteps: [
        'Trace weekly PM peak boardings Jun\u2013Sep to isolate the UW start date effect',
        'Identify which individual trips are running at max load 100',
        'Map segment-level loads to find where crowding peaks and where relief begins',
        'Compare summer baseline vs UW-in-session on the same corridor and time window',
        'Model specific operational responses (trippers, short-turns, coach swaps)',
      ],
      routeIds: ['44'],
      dateRange: { start: '2025-09-15', end: '2025-09-30' },
      deepLink: { periods: ['pm_peak'] },
      sparklineData: [
        { label: 'Jun 23', value: 24415 },
        { label: 'Jul 14', value: 24831 },
        { label: 'Aug 4', value: 24394 },
        { label: 'Aug 25', value: 24636 },
        { label: 'Sep 1', value: 22653 },
        { label: 'Sep 8', value: 27050 },
        { label: 'Sep 15', value: 36922 },
        { label: 'Sep 22', value: 43297 },
      ],
      walkthrough: [
        {
          pageName: 'The September Break',
          filterSummary: 'Jun 22 \u2013 Sep 30, 2025 \u00b7 All days \u00b7 All periods',
          narrative: 'Route 44 is Metro\u2019s Ballard\u2194UW crosstown lifeline \u2014 over 1 million boardings this summer on steady, predictable demand. PM peak hovered at ~24,800 weekly boardings every week from late June through August.\n\nThen UW\u2019s fall quarter started Sep 24. The week of Sep 22 logged 43,297 PM peak boardings \u2014 74% above the summer average. Every weekday since Sep 15 has recorded max load 100 somewhere along the route. The baseline isn\u2019t coming back.',
          filters: { tab: 'routes', routeId: '44', routeTab: 'Summary', startDate: '2025-06-22', endDate: '2025-09-30' },
          charts: [
            { id: 'r44-p1-trend', type: 'area', title: 'Weekly PM Peak Boardings', tooltipLabel: 'PM peak boardings', data: [
              { week: 'Jun 23', value: 24415 },
              { week: 'Jun 30', value: 25115 },
              { week: 'Jul 7',  value: 24593 },
              { week: 'Jul 14', value: 24831 },
              { week: 'Jul 21', value: 24771 },
              { week: 'Jul 28', value: 24864 },
              { week: 'Aug 4',  value: 24394 },
              { week: 'Aug 11', value: 24912 },
              { week: 'Aug 18', value: 24924 },
              { week: 'Aug 25', value: 24636 },
              { week: 'Sep 1',  value: 22653 },
              { week: 'Sep 8',  value: 27050 },
              { week: 'Sep 15', value: 36922 },
              { week: 'Sep 22', value: 43297 },
            ], xKey: 'week', yKey: 'value' },
            { id: 'r44-p1-maxload', type: 'area', title: 'Weekly PM Peak Max Load', tooltipLabel: 'max load', data: [
              { week: 'Jun 23', value: 41 },
              { week: 'Jun 30', value: 37 },
              { week: 'Jul 7',  value: 40 },
              { week: 'Jul 14', value: 33 },
              { week: 'Jul 21', value: 36 },
              { week: 'Jul 28', value: 36 },
              { week: 'Aug 4',  value: 35 },
              { week: 'Aug 11', value: 36 },
              { week: 'Aug 18', value: 35 },
              { week: 'Aug 25', value: 32 },
              { week: 'Sep 1',  value: 33 },
              { week: 'Sep 8',  value: 37 },
              { week: 'Sep 15', value: 100 },
              { week: 'Sep 22', value: 100 },
            ], xKey: 'week', yKey: 'value' },
          ],
        },
        {
          pageName: 'The 5 PM Crush',
          filterSummary: 'Sep 15 \u2013 Sep 30, 2025 \u00b7 Weekdays \u00b7 PM Peak',
          narrative: 'In UW\u2019s first two weeks, every outbound trunk trip between 4:55 and 5:55 PM ran at max load 100 \u2014 crush capacity on an articulated bus.\n\nThe 5:00, 5:15, 5:30, and 5:45 PM departures each averaged 71\u201374 passengers standing from UW through Wallingford. Short-turn trips in the same window averaged 40+. Thirteen of the fifteen trunk trips across the two weeks hit max load \u2014 the exception was a 4:55 PM trip that only reached 67.',
          filters: { tab: 'routes', routeId: '44', routeTab: 'Summary', startDate: '2025-09-15', endDate: '2025-09-30', daysMode: 'weekdays', timeMode: 'custom', timePeriods: ['PM Peak'], pattern: 'Ballard Wallingford' },
          relevantMetrics: ['Maxload'],
          charts: [
            { id: 'r44-p2-metric', type: 'metric', title: '', data: [], xKey: '', yKey: '', metricValue: '100', metricLabel: 'Max Load \u2014 Every PM Trunk Trip 5:00\u20135:55 PM' },
            { id: 'r44-p2-trips', type: 'bar', title: 'Max Load by Trip \u2014 Outbound Trunk Trips', tooltipLabel: 'max load', data: [
              { trip: '4:45', value: 100, fullName: '4:45 PM Trip' },
              { trip: '4:55', value: 67,  fullName: '4:55 PM Trip' },
              { trip: '5:00', value: 100, fullName: '5:00 PM Trip' },
              { trip: '5:15', value: 100, fullName: '5:15 PM Trip' },
              { trip: '5:16', value: 100, fullName: '5:16 PM Trip' },
              { trip: '5:30', value: 100, fullName: '5:30 PM Trip' },
              { trip: '5:31', value: 100, fullName: '5:31 PM Trip' },
              { trip: '5:45', value: 100, fullName: '5:45 PM Trip' },
              { trip: '5:46', value: 100, fullName: '5:46 PM Trip' },
            ], xKey: 'trip', yKey: 'value' },
          ],
        },
        {
          pageName: 'UW \u2192 Wallingford: The Crush Corridor',
          filterSummary: 'Sep 15 \u2013 Sep 30, 2025 \u00b7 Weekdays \u00b7 PM Peak \u00b7 Outbound',
          narrative: 'Buses fill at Montlake/Pacific \u2014 8,483 boardings in 12 days \u2014 and run crush-loaded westward. The peak load point is NE 45th & Latona with an average of 38 passengers on board.\n\nMeaningful alightings don\u2019t begin until N 45th & Wallingford. Anyone boarding at UW is standing, no matter which trip they catch. Every segment from U District Station through N 46th & Phinney hit max load 100 on at least one trip.',
          filters: { tab: 'routes', routeId: '44', routeTab: 'Summary', startDate: '2025-09-15', endDate: '2025-09-30', daysMode: 'weekdays', timeMode: 'custom', timePeriods: ['PM Peak'], pattern: 'Ballard Wallingford' },
          relevantMetrics: ['Maxload'],
          charts: [
            { id: 'r44-p3-segments', type: 'bar', title: 'Max Load by Segment \u2014 UW Outbound to Ballard', tooltipLabel: 'max load', data: [
              { segment: 'Montlake Blvd', value: 100, fromStopId: '29405' },
              { segment: 'Pacific & 15th', value: 100, fromStopId: '29420' },
              { segment: 'Campus Pkwy', value: 100, fromStopId: '29440' },
              { segment: '15th & 42nd', value: 100, fromStopId: '11352' },
              { segment: 'U District Stn', value: 100, fromStopId: '9587' },
              { segment: '9th Ave NE', value: 100, fromStopId: '29455' },
              { segment: 'Latona', value: 100, fromStopId: '29480' },
              { segment: 'Wallingford', value: 100, fromStopId: '17310' },
              { segment: 'Stone Way', value: 100, fromStopId: '29540' },
              { segment: 'Green Lake Way', value: 100, fromStopId: '29557' },
              { segment: 'Phinney', value: 100, fromStopId: '29600' },
              { segment: 'Market & 48th', value: 100, fromStopId: '29620' },
            ], xKey: 'segment', yKey: 'value' },
          ],
        },
        {
          pageName: 'Summer vs UW-in-Session',
          filterSummary: 'Sep 15 \u2013 Sep 30 vs Jun 22 \u2013 Aug 24 \u00b7 Weekdays \u00b7 PM Peak \u00b7 Outbound',
          narrative: 'Same corridor, same time of day. This summer, the UW\u2192Wallingford segments averaged 12\u201315 passengers on board and never exceeded max load 41.\n\nSince UW returned, every segment hits max load 100 and average loads have nearly tripled \u2014 NE 45th & Latona went from 14.6 to 38.4. This isn\u2019t a one-week spike; it\u2019s the new operating reality for fall and winter quarters.',
          filters: { tab: 'routes', routeId: '44', routeTab: 'Summary', startDate: '2025-09-15', endDate: '2025-09-30', daysMode: 'weekdays', timeMode: 'custom', timePeriods: ['PM Peak'], comparisonMode: true, comparisonStartDate: '2025-06-22', comparisonEndDate: '2025-08-24', pattern: 'Ballard Wallingford' },
          relevantMetrics: ['Maxload'],
          charts: [
            { id: 'r44-p4-metric', type: 'comparison-metric', title: '', data: [], xKey: '', yKey: '', metricValue: '100', metricValue2: '41', metricLabel: 'Max Load on the Corridor \u2014 UW Weeks vs Summer' },
            { id: 'r44-p4-compare', type: 'bar', title: 'Max Load by Segment \u2014 UW vs Summer', tooltipLabel: 'max load', data: [
              { segment: 'Montlake Blvd',    uw: 100, summer: 13, fromStopId: '29405' },
              { segment: 'Campus Pkwy',      uw: 100, summer: 24, fromStopId: '29440' },
              { segment: 'U District Stn',   uw: 100, summer: 35, fromStopId: '9587'  },
              { segment: 'Latona',           uw: 100, summer: 41, fromStopId: '29480' },
              { segment: 'Wallingford',      uw: 100, summer: 41, fromStopId: '17310' },
              { segment: 'Stone Way',        uw: 100, summer: 34, fromStopId: '29540' },
            ], xKey: 'segment', yKey: 'uw', yKey2: 'summer' },
          ],
        },
        {
          pageName: 'Recommended Actions',
          filterSummary: 'Operational response \u00b7 Target live: Oct 20, 2025',
          narrative: '**1. Add 3 PM trippers outbound from UW Station** at 4:50, 5:05, and 5:20 PM, weekdays. These slot between trunks averaging 71+ passengers. Articulated assignments required. Cost: ~1.5 service hours/weekday (~375 SVH/quarter).\n\n**2. Run 2 UW\u2192Wallingford short-turn loops per hour** during 4:30\u20136 PM. A 7-stop loop from Montlake Blvd to N 45th & Wallingford adds capacity exactly where the crush is, without a full Ballard lap. Cuts crew/equipment cost ~60% vs. adding trunk trips.\n\n**3. Audit articulated coach assignments** Mon\u2013Fri 4\u20136 PM outbound. Any 40-ft coach swap recovers ~35 seats. Check the schedule \u2014 swap any remaining non-articulated trips in the PM peak block.\n\n**4. Stage observers for pass-up counts** at Montlake/Pacific Pl and NE Pacific/15th Ave in Week 3 of quarter (Oct 6\u201310). APC caps at load 100 but doesn\u2019t count denied boardings \u2014 ground truth required before finalizing tripper frequency.\n\n**5. Lock it in for Winter quarter.** UW Winter 2026 starts Jan 5 with similar enrollment. Ship trippers by Oct 20 to dial in operators through fall break, ready for Jan return.',
          filters: { tab: 'routes', routeId: '44', routeTab: 'Trips', startDate: '2025-09-15', endDate: '2025-09-30', daysMode: 'weekdays', timeMode: 'custom', timePeriods: ['PM Peak'] },
          charts: [],
        },
      ],
    },
