...
const SaveBookmarkModal: React.FC<SaveBookmarkModalProps> = ({
  ...
  // Default showScrim to true for edit mode, false for create mode
  const shouldShowScrim = showScrim ?? mode === 'edit';
  ...
  return createPortal(
    <div
      ...
      style={{
        position: 'fixed',
        inset: 0,
        backgroundColor: shouldShowScrim ? 'var(--bg-primary)' : 'transparent',
        display: 'flex',
        alignItems: 'center',
        ...
        >
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            {(contextTitle || contextSubtitle) && (
              <div style={{ marginBottom: '20px', display: 'flex', flexDirection: 'column', gap: '8px', paddingBottom: '20px', borderBottom: '0.5px solid var(--border-default)' }}>
                {contextTitle && (
                  <div style={{
                    fontSize: '13px',
